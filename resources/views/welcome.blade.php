    ...
    <div class="w-full" style="background-image: url('http://localhost:8000/images/banner.jpg');background-position: center; height: 600px;">
        <div class="w-full h-full flex flex-col items-center justify-between bg-black bg-opacity-70 py-8">
            <div class="flex-1 flex flex-col items-center justify-center">
                ...
                <div class="bg-white bg-opacity-10 px-4 py-2 mt-6 rounded-xl flex items-center justify-center text-cyan-100 space-x-2 lg:space-x-4">
                ...
                <div class="flex flex-col items-center space-y-4 mt-12">
                    <form class="w-full flex items-center">
                        <input type="email" name="email" id="email" class="w-72 p-2 mr-4 border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded-tl rounded-bl text-sm" placeholder="faites une recherche" autocomplete="off">
                        <button class="bg-blue-600 hover:bg-blue-700 py-2 px-6 text-gray-100 border border-blue-600 rounded-tr rounded-br text-sm">Rechercher</button>
                    </form>
                </div>
            </div>
        </div>
